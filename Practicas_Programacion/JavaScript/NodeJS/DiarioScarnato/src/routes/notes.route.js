        ...
        const calendarioNotasDiario = (
            ...
            .map(elem =>{
                ...
                switch (elem.medicina) {
                    ...
                    case "Enantyum": elem.medicamento = "7"; break;
                    case "FlocurRapid": elem.medicamento = "8"; break;
                    case "Geniol": elem.medicamento = "9"; break;
                    case "Otro": elem.medicamento = "10"; break;
