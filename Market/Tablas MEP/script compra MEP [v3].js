...
async function generarListaOrdenadaCEDEARS(){
    // let i=0
    // aa_json.result.find(elem=>elem.ticker==extracto[i]).stockOffer.askTop[0].price /
    // aa_json.result.find(elem=>elem.ticker==extracto[i]+"D").stockOffer.bidTop[0].price
    window.aa_json =''
    ...
    extracto.forEach(ticker=>{
        cotizacion_resultante = aa_json.result.find(elem=>elem.ticker==ticker)?.stockOffer?.askTop[0]?.price /
                                        aa_json.result.find(elem=>elem.ticker==ticker+"D")?.stockOffer?.bidTop[0]?.price;
...
async function generarListaOrdenadaON(){
    // let i=0
    // aa_json.result.find(elem=>elem.ticker==extractoON[i]).stockOffer.askTop[0].price /
    // aa_json.result.find(elem=>elem.ticker==extractoON[i]+"D").stockOffer.bidTop[0].price
    window.aa_json =''
    ...
    extractoON.forEach(ticker=>{
        cotizacion_resultante = aa_json.result.find(elem=>elem.ticker==ticker.slice(0, -1) +"O")?.stockOffer?.askTop[0]?.price /
...
async function generarTabla(){
    ...
    cell = row.insertCell();
    cell.innerText = "Precio Compra MEP Cotización CEDEAR (Cdo - 24Hs Parking)";
    ...
    cell.innerText = "©polyys";
    cell = row.insertCell();
    cell.innerText = "Precio Compra MEP Cotización CEDEAR (48Hs - 72hs Parking)";
    ...
    cell.innerText = "©polyys";
    cell = row.insertCell();
    cell.innerText = "Precio Compra MEP Cotización ON (Cdo - 24Hs Parking)";
    ...
    cell.innerText = "©polyys";
    cell = row.insertCell();
    cell.innerText = "Precio Compra MEP Cotización ON  (48hs - 72hs Parking)";
